    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="admin-menu">
        <div class="navbar-nav">
          ...
          <a class="nav-link <?= $data['page'] == "alumni" ? "btn btn-primary text-white" : "" ?>" href="<?= ROOT_URL."alumni" ?>">Alumni</a>
          <a class="nav-link <?= $data['page'] == "perusahaan" ? "btn btn-primary text-white" : "" ?>" href="<?= ROOT_URL."perusahaan" ?>">Perusahaan</a>
        </div>
