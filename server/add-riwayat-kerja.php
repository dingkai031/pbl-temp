...
$query_add_riwayat_kerja = "INSERT INTO riwayat_kerja (id_user, id_perusahaan, lama_kerja, posisi, penghasilan, created_at, updated_at) VALUES ('".$_SESSION['id']."', '".$decoded_escaped['id_perusahaan']."', '".$decoded_escaped['lama-kerja']."', '".$decoded_escaped['posisi']."', '".$decoded_escaped['penghasilan']."', '".dateToday()."', '".dateToday()."')";
